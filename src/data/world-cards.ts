    ...
    npcs: [
      {
        ...
        fields: {
          ...
          birthday: '',
          currentSelfPerception: '怀才不遇的书生，突然卷入一场关乎王朝命运的追寻中',
          currentState: '在春雨中的旧书摊前，怀揣着刚得到的古卷',
      ...
      },
      {
        ...
        fields: {
          ...
          birthday: '',
          currentSelfPerception: '看尽王朝兴衰的说书人，知道太多不该知道的事',
          currentState: '在茶馆里敲着醒木说书，目光时不时扫过门口',
      ...
      },
      {
        ...
        fields: {
          ...
          birthday: '',
          currentSelfPerception: '沉默的守护者，眼见灵力消散却无能为力',
          currentState: '在密林深处的竹屋中打坐，感知到有人闯入灵域',
      ...
      },
      {
        ...
        fields: {
          ...
          birthday: '',
          currentSelfPerception: '冷面热心的朝廷命官，对官场腐败深恶痛绝却不得不虚与委蛇',
          currentState: '身着便装出现在各地，暗中调查灵兽消失和龙脉异象的关联',
